...
ActiveRecord::Schema[7.0].define(version: 2025_02_26_144308) do
  ...
  create_table "clothings", charset: "utf8mb3", force: :cascade do |t|
  ...
  add_foreign_key "cart_items", "clothings"
